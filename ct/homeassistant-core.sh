#!/usr/bin/env bash
source <(curl -fsSL https://raw.githubusercontent.com/phreakmunkay/ProxmoxVE/main/misc/build.func)
...
function update_script() {
  ...
  if ! lsb_release -d | grep -q "Ubuntu 24.10"; then
    ...
    msg_error "Read Guide: https://github.com/phreakmunkay/ProxmoxVE/discussions/1549"
    exit 1
  fi
