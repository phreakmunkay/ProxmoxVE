...
source /dev/stdin <<<$(curl -fsSL https://raw.githubusercontent.com/phreakmunkay/ProxmoxVED/main/misc/api.func)
source <(curl -fsSL https://git.community-scripts.org/phreakmunkay/ProxmoxVED/raw/branch/main/misc/vm-core.func)
load_functions
